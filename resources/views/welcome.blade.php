...
<input type = "button" id = "driver" value = "Load Data" />
       ...
       <div class="flex-center position-ref full-height">
          ...
          <div class="container">
            <h1>REGISTRATION</h1>
   <form method="POST" action="/registered" class="was-validated">
            {{csrf_field()}}
 ...
 <br>
  ...
  <div class="form-group">
      ...
      <input type="textarea" class="form-control" id="comments" placeholder="Enter comments" name="comments" required>
    </div><br>
 
  <div class="form-group">
      <label for="course">Course:</label>
      <select class="form-control" id="course" placeholder="Enter course" name="course" required>
...
@endforeach
  ...
  <div class="form-group">
      ...
      <select class="form-control" id="state" placeholder="Enter state" name="state" required>

@foreach($cour as $cour)
<option value="{{$cour->state}}">{{$cour->state}}</option> 
@endforeach
    </select>
</div><br>
 ...
 <div class="form-check-inline">
      Gender:<label class="form-check-label" for="radio1">
        <input type="radio" class="form-check-input" id="radio1" name="gender" value="option1">Male
      </label>
    </div><br>
    <div class="form-check-inline">
